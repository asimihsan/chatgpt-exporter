...
u$1(Content$1, { className: "DialogContent", children: open && u$1(DialogContent, { format }) })
  ...
  function MenuInner({ container }) {
    ...
    const contentClassName = `
        ...
        ${isMobile ? "gap-x-1 px-1.5 pt-2 rounded ce-animate-slide-up" : "gap-x-1 px-1.5 py-2 pb-0 rounded-md ce-animate-fade-in"}
    `;
    if (disabled) {
      return u$1(
        MenuItem,
